...
# Red team
import paintwars_sarmale # importer votre code
get_name_red_team = paintwars_sarmale.get_team_name # mettre ici votre fonction get_team_name
step_red_team = paintwars_sarmale.step # mettre ici votre fonction step
